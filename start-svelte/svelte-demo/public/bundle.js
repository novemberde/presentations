...
var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block.name, type: "each", source: "(38:2) {#each items as item}", ctx });
    	return block;
    }

    function create_fragment(ctx) {
    	var div1, h1, t1, input, t2, div0, t3, t4, ul, dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 33, 1, 491);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "class", "svelte-19469wf");
    			add_location(input, file, 34, 1, 508);
    			add_location(div0, file, 35, 1, 574);
    			set_style(ul, "display", "none");
    			add_location(ul, file, 36, 1, 594);
    			attr_dev(div1, "class", "App-header svelte-19469wf");
    			add_location(div1, file, 32, 0, 465);
